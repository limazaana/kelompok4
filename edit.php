...
// 1. Ambil data buku untuk ditampilkan di formulir
if (isset($_GET['id'])) {
    $id = $_GET['id'];
...
// 2. Proses pembaruan data saat tombol simpan ditekan
if (isset($_POST['update'])) {
    ...
    // Jalankan perintah pembaruan (Update)
    ...
    if ($conn->query($sql)) {
        ...
        echo "Kesalahan saat memperbarui: " . $conn->error;
    }
}
?>
